...
public class CargoLifecycleScenarioTest {
    ...
    public void testCargoFromHongkongToStockholm() throws Exception {
        ...
        LocalDateTime arrivalDeadline = DateUtil.toDate("2009-03-18");
        ...
        Assert.assertEquals(TransportStatus.NOT_RECEIVED,
                cargo.getDelivery().getTransportStatus());
        Assert.assertEquals(RoutingStatus.NOT_ROUTED,
        ...
        Assert.assertEquals(Voyage.NONE,
                cargo.getDelivery().getCurrentVoyage());
