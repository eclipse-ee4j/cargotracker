...
public class CargoLifecycleScenarioTest {
	...
	public void testCargoFromHongkongToStockholm() throws Exception {
		...
		assertEquals(new HandlingActivity(HandlingEvent.Type.RECEIVE, SampleLocations.HONGKONG),
		...
		assertFalse(cargo.getDelivery().isMisdirected());
		assertEquals(new HandlingActivity(HandlingEvent.Type.UNLOAD, SampleLocations.NEWYORK, SampleVoyages.v100),
				cargo.getDelivery().getNextExpectedActivity());
		...
		assertEquals(TransportStatus.ONBOARD_CARRIER, cargo.getDelivery().getTransportStatus());
		assertFalse(cargo.getDelivery().isMisdirected());
		assertEquals(new HandlingActivity(HandlingEvent.Type.UNLOAD, SampleLocations.HAMBURG, SampleVoyages.v300),
				cargo.getDelivery().getNextExpectedActivity());
		...
		assertEquals(TransportStatus.IN_PORT, cargo.getDelivery().getTransportStatus());
		assertFalse(cargo.getDelivery().isMisdirected());
		assertEquals(new HandlingActivity(HandlingEvent.Type.LOAD, SampleLocations.HAMBURG, SampleVoyages.v400),
				cargo.getDelivery().getNextExpectedActivity());
		...
		assertEquals(TransportStatus.ONBOARD_CARRIER, cargo.getDelivery().getTransportStatus());
		assertFalse(cargo.getDelivery().isMisdirected());
		assertEquals(new HandlingActivity(HandlingEvent.Type.UNLOAD, SampleLocations.STOCKHOLM, SampleVoyages.v400),
				cargo.getDelivery().getNextExpectedActivity());
		...
		assertEquals(TransportStatus.IN_PORT, cargo.getDelivery().getTransportStatus());
		assertFalse(cargo.getDelivery().isMisdirected());
		assertEquals(new HandlingActivity(HandlingEvent.Type.CLAIM, SampleLocations.STOCKHOLM),
				cargo.getDelivery().getNextExpectedActivity());
