...
aggregates, services, repositories, and factories. The xref:characterization:main/main.adoc[Characterization] section overviews how these concepts are 
...
layer (of course!) and the infrastructure layer respectively. The xref:layers:main/main.adoc[Layers] 
