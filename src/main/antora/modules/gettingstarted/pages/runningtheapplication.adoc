...
or set it up in your favorite IDE. We currently have https://github.com/eclipse-ee4j/cargotracker/wiki/Visual-Studio-Code[instructions for Visual Studio Code.]
