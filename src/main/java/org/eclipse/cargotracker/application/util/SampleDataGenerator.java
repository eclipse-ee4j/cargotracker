    ...
    private void loadSampleCargos() {
        ...
        RouteSpecification routeSpecification1 =
                new RouteSpecification(
                        ...
                        Date.from(Instant.from(LocalDate.now().plusDays(15))));
                ...
                new Itinerary(
                        Arrays.asList(
                                new Leg(
                                        ...
                                        Date.from(Instant.from(LocalDate.now().minusDays(7))),
                                        Date.from(Instant.from(LocalDate.now().minusDays(1)))),
                                new Leg(
                                        SampleVoyages.NEW_YORK_TO_DALLAS,
                                        SampleLocations.NEWYORK,
                                        SampleLocations.DALLAS,
                                        Date.from(Instant.from(LocalDate.now().plusDays(2))),
                                        Date.from(Instant.from(LocalDate.now().plusDays(6)))),
                                new Leg(
                                        SampleVoyages.DALLAS_TO_HELSINKI,
                                        SampleLocations.DALLAS,
                                        SampleLocations.HELSINKI,
                                        Date.from(Instant.from(LocalDate.now().plusDays(8))),
                                        Date.from(Instant.from(LocalDate.now().plusDays(14))))));
        ...
        try {
            HandlingEvent event1 =
                    handlingEventFactory.createHandlingEvent(
                            new Date(),
                            Date.from(Instant.from(LocalDate.now().minusDays(10))),
                            trackingId1,
                            null,
        ...
        RouteSpecification routeSpecification2 =
                new RouteSpecification(
                        ...
                        Date.from(Instant.from(LocalDate.now().plusDays(18))));
                ...
                new Itinerary(
                        Arrays.asList(
                                new Leg(
                                        ...
                                        SampleLocations.NEWYORK,
                                        Date.from(Instant.from(LocalDate.now().minusDays(10))),
                                        Date.from(Instant.from(LocalDate.now().minusDays(3)))),
                                new Leg(
                                        SampleVoyages.NEW_YORK_TO_DALLAS,
                                        SampleLocations.NEWYORK,
                                        SampleLocations.DALLAS,
                                        Date.from(Instant.from(LocalDate.now().minusDays(2))),
                                        Date.from(Instant.from(LocalDate.now().plusDays(2)))),
                                new Leg(
                                        SampleVoyages.DALLAS_TO_HELSINKI,
                                        SampleLocations.DALLAS,
        ...
        try {
            HandlingEvent event1 =
                    handlingEventFactory.createHandlingEvent(
                            new Date(),
                            Date.from(Instant.from(LocalDate.now().minusDays(15))),
                            trackingId2,
                            null,
        ...
        RouteSpecification routeSpecification4 =
                new RouteSpecification(
                        SampleLocations.NEWYORK,
                        SampleLocations.DALLAS,
                        Date.from(Instant.from(LocalDate.now().minusDays(24))));
                ...
                new Itinerary(
                        Arrays.asList(
                                new Leg(
                                        ...
                                        SampleLocations.NEWYORK,
                                        SampleLocations.DALLAS,
                                        Date.from(Instant.from(LocalDate.now().minusDays(34))),
                                        Date.from(Instant.from(LocalDate.now().minusDays(28))))));
        ...
        try {
            HandlingEvent event1 =
                    handlingEventFactory.createHandlingEvent(
                            new Date(),
                            Date.from(Instant.from(LocalDate.now().minusDays(37))),
                            trackingId4,
                            null,
                            SampleLocations.NEWYORK.getUnLocode(),
                            HandlingEvent.Type.RECEIVE);
            ...
            HandlingEvent event4 =
                    handlingEventFactory.createHandlingEvent(
                            new Date(),
                            Date.from(Instant.from(LocalDate.now().minusDays(27))),
                            trackingId4,
                            null,
                            SampleLocations.DALLAS.getUnLocode(),
            ...
            HandlingEvent event5 =
                    handlingEventFactory.createHandlingEvent(
                            new Date(),
                            Date.from(Instant.from(LocalDate.now().minusDays(26))),
                            trackingId4,
                            null,
                            SampleLocations.DALLAS.getUnLocode(),
