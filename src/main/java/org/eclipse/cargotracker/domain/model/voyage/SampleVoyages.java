...
public class SampleVoyages {
  ...
  public static final Voyage HONGKONG_TO_NEW_YORK =
      new Voyage.Builder(new VoyageNumber("0100S"), SampleLocations.HONGKONG)
          .addMovement(
              SampleLocations.HANGZOU, toDate("2013-10-01", "12:00"), toDate("2013-10-03", "14:30"))
          .addMovement(
              SampleLocations.TOKYO, toDate("2013-10-03", "21:00"), toDate("2013-10-06", "06:15"))
          .addMovement(
              SampleLocations.MELBOURNE,
              toDate("2013-10-06", "11:00"),
              toDate("2013-10-12", "11:30"))
          .addMovement(
              SampleLocations.NEWYORK, toDate("2013-10-14", "12:00"), toDate("2013-10-23", "23:10"))
          .build();
  /**
  ...
  public static final Voyage NEW_YORK_TO_DALLAS =
      new Voyage.Builder(new VoyageNumber("0200T"), SampleLocations.NEWYORK)
          .addMovement(
              SampleLocations.CHICAGO, toDate("2013-10-24", "07:00"), toDate("2013-10-24", "17:45"))
          .addMovement(
              SampleLocations.DALLAS, toDate("2013-10-24", "21:25"), toDate("2013-10-25", "19:30"))
          .build();
  /**
  ...
  public static final Voyage DALLAS_TO_HELSINKI =
      new Voyage.Builder(new VoyageNumber("0300A"), SampleLocations.DALLAS)
          .addMovement(
              SampleLocations.HAMBURG, toDate("2013-10-29", "03:30"), toDate("2013-10-31", "14:00"))
          .addMovement(
