...
public class SampleVoyages {
    ...
    public final static Voyage v100 = new Voyage.Builder(
            new VoyageNumber("V100"), SampleLocations.HONGKONG)
            .addMovement(SampleLocations.TOKYO, toDate("2014-03-03"), toDate("2014-03-05"))
            .addMovement(SampleLocations.NEWYORK, toDate("2014-03-06"), toDate("2014-03-09"))
            .build();
    public final static Voyage v200 = new Voyage.Builder(
            new VoyageNumber("V200"), SampleLocations.TOKYO)
            ...
            .addMovement(SampleLocations.STOCKHOLM, toDate("2014-03-14"), toDate("2014-03-16"))
            .build();
    public final static Voyage v300 = new Voyage.Builder(
            new VoyageNumber("V300"), SampleLocations.TOKYO)
    ...
    public final static Voyage v400 = new Voyage.Builder(
            new VoyageNumber("V400"), SampleLocations.HAMBURG)
            ...
            .addMovement(SampleLocations.HAMBURG, toDate("2014-03-20"), toDate("2014-03-22"))
            .build();
    /**
    ...
    public static final Voyage HONGKONG_TO_NEW_YORK = new Voyage.Builder(
            new VoyageNumber("0100S"), SampleLocations.HONGKONG)
            .addMovement(SampleLocations.HANGZOU, toDate("2013-10-01", "12:00"),
                    toDate("2013-10-03", "14:30"))
            .addMovement(SampleLocations.TOKYO, toDate("2013-10-03", "21:00"),
                    toDate("2013-10-06", "06:15"))
            .addMovement(SampleLocations.MELBOURNE, toDate("2013-10-06", "11:00"),
                    toDate("2013-10-12", "11:30"))
            .addMovement(SampleLocations.NEWYORK, toDate("2013-10-14", "12:00"),
    ...
    public static final Voyage NEW_YORK_TO_DALLAS = new Voyage.Builder(
            new VoyageNumber("0200T"), SampleLocations.NEWYORK)
            .addMovement(SampleLocations.CHICAGO, toDate("2013-10-24", "07:00"),
                    toDate("2013-10-24", "17:45"))
            .addMovement(SampleLocations.DALLAS, toDate("2013-10-24", "21:25"),
    ...
    public static final Voyage DALLAS_TO_HELSINKI = new Voyage.Builder(
            new VoyageNumber("0300A"), SampleLocations.DALLAS)
            .addMovement(SampleLocations.HAMBURG, toDate("2013-10-29", "03:30"),
                    toDate("2013-10-31", "14:00"))
            .addMovement(SampleLocations.STOCKHOLM, toDate("2013-11-01", "15:20"),
                    toDate("2013-11-01", "18:40"))
            .addMovement(SampleLocations.HELSINKI, toDate("2013-11-02", "09:00"),
    ...
    public static final Voyage DALLAS_TO_HELSINKI_ALT = new Voyage.Builder(
            new VoyageNumber("0301S"), SampleLocations.DALLAS)
            .addMovement(SampleLocations.HELSINKI, toDate("2013-10-29", "03:30"),
    ...
    public static final Voyage HELSINKI_TO_HONGKONG = new Voyage.Builder(
            new VoyageNumber("0400S"), SampleLocations.HELSINKI)
            .addMovement(SampleLocations.ROTTERDAM, toDate("2013-11-04", "05:50"),
                    toDate("2013-11-06", "14:10"))
            .addMovement(SampleLocations.SHANGHAI, toDate("2013-11-10", "21:45"),
                    toDate("2013-11-22", "16:40"))
            .addMovement(SampleLocations.HONGKONG, toDate("2013-11-24", "07:00"),
