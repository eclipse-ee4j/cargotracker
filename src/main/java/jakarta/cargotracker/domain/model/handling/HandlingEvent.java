 ...
 * some time after the event occurred and contain information about the null {@link jakarta.cargotracker.domain.model.cargo.TrackingId},
 * {@link jakarta.cargotracker.domain.model.location.Location}, time stamp of
 * the completion of the event, and possibly, if applicable a
 * {@link jakarta.cargotracker.domain.model.voyage.Voyage}.
 * <p/>
